...
/*11. Un error ha fet que totes les factures emeses el dia 28 de gener de 2013 siguin errònies: es van guardar a la base de dades, però no es van cobrar ni es van entregar les cançons. Elimina totes les factures emeses aquest dia.*/
